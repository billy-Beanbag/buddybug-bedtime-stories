...
def build_story_generation_prompt(story_brief: StoryBrief) -> str:
    ...
    return "\n".join(
        [
            ...
            f"Source title: {story_brief.source_title or 'none'}",
            f"Core story premise to preserve: {story_brief.source_premise or 'none'}",
            ...
            "Story rules:",
            rules,
            "Premise preservation rules:",
            "- The final story must clearly retain the concrete situation from the core story premise above.",
            "- Do not replace the premise with a generic mystery, generic clue hunt, or abstract problem unless the premise itself is specifically about that.",
            "- Name and show the actual objects, animals, place, and situation from the premise in the opening paragraph.",
            "- If the source premise mentions a zoo, picnic, elephant, baking, kitchen, bedroom item, or another concrete setup, keep that setup central to the story rather than turning it into a vague substitute beat.",
            "Beat card:",
