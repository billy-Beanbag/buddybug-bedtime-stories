    ...
    <div className="space-y-12 md:space-y-16">
      ...
      <section className="grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-sm">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600">
            The Free Plan is a lighter way to begin. Premium adds unlimited stories, full library access, bedtime packs, narration voices, downloadable offline stories, unlimited child profiles, and personalised recommendations.
          </p>
        </div>
      </section>
